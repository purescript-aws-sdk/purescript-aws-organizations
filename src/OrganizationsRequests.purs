...
attachPolicy :: forall eff. Organizations.Service -> OrganizationsTypes.AttachPolicyRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
deleteOrganization :: forall eff. Organizations.Service ->  Aff (exception :: EXCEPTION | eff) Types.NoOutput
deleteOrganization (Organizations.Service serviceImpl) = AWS.request serviceImpl method (Types.NoInput unit) where
...
deleteOrganizationalUnit :: forall eff. Organizations.Service -> OrganizationsTypes.DeleteOrganizationalUnitRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
deletePolicy :: forall eff. Organizations.Service -> OrganizationsTypes.DeletePolicyRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
describeOrganization (Organizations.Service serviceImpl) = AWS.request serviceImpl method (Types.NoInput unit) where
...
detachPolicy :: forall eff. Organizations.Service -> OrganizationsTypes.DetachPolicyRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
disableAWSServiceAccess :: forall eff. Organizations.Service -> OrganizationsTypes.DisableAWSServiceAccessRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
enableAWSServiceAccess :: forall eff. Organizations.Service -> OrganizationsTypes.EnableAWSServiceAccessRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
leaveOrganization :: forall eff. Organizations.Service ->  Aff (exception :: EXCEPTION | eff) Types.NoOutput
leaveOrganization (Organizations.Service serviceImpl) = AWS.request serviceImpl method (Types.NoInput unit) where
...
moveAccount :: forall eff. Organizations.Service -> OrganizationsTypes.MoveAccountRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
removeAccountFromOrganization :: forall eff. Organizations.Service -> OrganizationsTypes.RemoveAccountFromOrganizationRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
